    ...
    <div className="border-2 flex border-black w-90 rounded-2xl h-85">
        ...
        <div className="overflow-y-auto px-2 pb-1">
          {skills.map((i: Skills, index) => (
            ...
            >
              <input
                type="checkbox"
                className="appearance-none w-5 h-5 border-2 border-gray-500 rounded-md cursor-pointer 
                   checked:bg-amber-500 checked:border-amber-600 transition-all duration-200 
                   hover:border-amber-400 shadow-sm
              ...
              <div className="flex-1 flex justify-end">
                <input type="text" className="w-5 border-b " />
              </div>
            </label>
          ))}
        </div>
      ...
      <div className="float-right h-84 w-45 border-l border-black flex flex-col justify-between">
        ...
        <div className="overflow-y-auto px-2">
          {uniqSkills.map((i: Skills, index) => (
            ...
            >
              ...
              {/* stat + modifier w jednym bloku, zawsze w tym samym miejscu */}
        ...
        >
          ...
          <select
            name="skillModifyer"
            className="mx-1 w-12 px-2  bg-transparent text-gray-800
             border-b-2 border-amber-600 focus:outline-none focus:border-amber-700
             appearance-none"
          >
